...
public class Problem_10_7{
    ...
    public static List<BinaryNode> inorder(BinaryNode tree){
        ...
        List<BinaryNode> inorderTraversal = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        List<BinaryNode> list = inorder(a);
